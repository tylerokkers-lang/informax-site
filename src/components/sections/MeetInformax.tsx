      ...
      <div className="mx-auto max-w-8xl px-6 md:px-8">
        ...
        <RevealStagger className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] items-center gap-8 md:gap-5">
          <RevealStaggerItem className="text-center">
            ...
            <div className="max-w-[220px] mx-auto mb-5 rounded-3xl border border-line bg-gradient-to-br from-charcoal-800 to-charcoal-900 p-2.5 shadow-[0_24px_50px_-24px_rgba(20,20,28,0.35)]">
              <div className="relative flex aspect-[9/16] flex-col items-center justify-center gap-2.5 overflow-hidden rounded-2xl bg-[radial-gradient(circle_at_50%_45%,rgba(138,124,255,0.22),var(--charcoal-950)_65%)] p-4">
